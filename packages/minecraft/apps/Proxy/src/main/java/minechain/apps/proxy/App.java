...
@Plugin(id = "myfirstplugin", name = "My First Plugin", version = "0.1.0-SNAPSHOT", url = "https://example.org", description = "I did it!", authors = {
        "Me" })
public class App {
    ...
    public void onPlayerChat(PlayerChatEvent p) {
        var serv = this.server.getServer("second");
        if (serv.isPresent()) {
